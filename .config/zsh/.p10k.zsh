# Generated by Powerlevel10k configuration wizard on 2023-01-24 at 13:01 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=97
  ...
  function prompt_vifm_prompt() {
    if [[ -n $INSIDE_VIFM ]]; then
      p10k segment -f yellow -t '{VF}'
    fi
  }
  ...
  function instant_prompt_vifm_prompt() {
    prompt_vifm_prompt
  }
