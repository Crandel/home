...
//user_pref("browser.tabs.loadDivertedInBackground", false); // Open browser immediately after open link
...
user_pref("calendar.google.sendEventNotifications", true);
user_pref("calendar.google.enableAttendees", true);
user_pref("calendar.date.format", 1);
user_pref("calendar.event.defaultlength", 30);
...
user_pref("mail.citation_color", "#80d204");
